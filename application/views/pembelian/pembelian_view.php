    <div class="row bg-white has-shadow">
        <div class="col-md-12">
            ...
            <br>
            <a href="<?php echo base_url('index.php/pembelian/tambah_pembelian')?>" class="btn btn-success">Tambah Pembelian</a>
...
<!-- AJAX -->
    <script type="text/javascript">
        function showModal(id_penjualan){
            $.ajax({
                url:"<?php echo base_url('index.php/pembelian/detail_transaksi/')?>"+id_penjualan,
                type:"GET",
        ...
        $(document).ready(function() {
            table = $('#table').DataTable({ 
                ...
                "ajax": {
                    "url": "<?php echo site_url('pembelian/read_pembelian')?>",
                    "type": "POST"
                },
